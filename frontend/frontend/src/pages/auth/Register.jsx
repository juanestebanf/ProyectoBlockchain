        ...
        <div style={{ width: '100%', maxWidth: '420px' }}>
          ...
          <div className="mb-4">
            ...
            <p style={{ color: '#5A6A7A', fontSize: '0.95rem', margin: 0 }}>
              Regístrate en SmartRent para comenzar
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              ...
              >
                <i className="bi bi-info-circle me-1" style={{ color: '#C6A15B' }}></i>
                <span style={{ color: '#5A6A7A', fontSize: '0.8rem' }}>
          ...
          >
            ...
            Tus datos están protegidos con Blockchain
          </div>
        </div>
      </div>
    </div>
